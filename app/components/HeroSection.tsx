    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(180deg, rgba(10, 22, 40, 0.85) 0%, rgba(10, 22, 40, 0.75) 100%)",
        }}
      />
      ...
      >
        ...
        >
          ...
          >
            The digital standard for verified African critical minerals,
            industrial chemicals, and raw materials. WG Trade provides the
            transparency, logistics, and certified purity required for the
          ...
          >
            ...
            {["PET Resin", "Titanium Dioxide", "Solvents", "Carbon Black"].map(
              (term) => (
                <Link
                  key={term}
