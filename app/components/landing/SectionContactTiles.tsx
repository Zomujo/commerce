      ...
      <div className="w-full flex flex-col md:flex-row min-h-[50vh]">
        ...
        <div className="w-full md:w-1/2 group relative flex flex-col justify-between p-12 sm:p-16 lg:p-24 transition-all duration-700 hover:scale-[1.02] z-10 hover:z-20 shadow-2xl"
          ...
          <div className="relative z-10 flex flex-col flex-grow">
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-medium tracking-tight text-[#06231A] group-hover:text-white transition-colors duration-500 leading-[1.1] max-w-sm mb-4">
        ...
        <div className="w-full md:w-1/2 group relative flex flex-col justify-between p-12 sm:p-16 lg:p-24 transition-all duration-700 hover:scale-[1.02] z-10 hover:z-20 shadow-2xl"
          ...
          <div className="relative z-10 flex flex-col flex-grow">
            <div className="mb-8">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-gray-400 group-hover:text-[#D4C9A8] transition-colors duration-500">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
            </div>
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-medium tracking-tight text-white group-hover:text-white transition-colors duration-500 leading-[1.1] max-w-sm mb-4">
          ...
          <div className="relative z-10 mt-16 lg:mt-32">
            {onPartnerClick ? (
              <button
                ...
                className="group/btn flex items-center text-sm font-bold text-[#D4C9A8] uppercase tracking-widest w-fit"
              >
                <span className="bg-gradient-to-t from-[#D4C9A8]/20 to-transparent bg-no-repeat bg-[length:100%_40%] bg-bottom group-hover/btn:bg-[length:100%_100%] transition-all duration-300">
                  TRADE WITH US
                </span>
                <svg className="w-5 h-5 ml-3 transition-transform group-hover/btn:translate-x-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
